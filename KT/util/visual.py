...
def wtf_radar_chart():
    ...
    categories = ['Skill1', 'Skill2', 'Skill3', 'Skill4', 'Skill5']
    player1_data = [1.4, 1.6, 3.1, 2.6, 3.7]
    player2_data = [3.2, 4.0, 2.5, 2.0, 3.67]
    player3_data = [3.3, 4.4, 3.0, 2.54, 4]
    player4_data = [3.9, 4.1, 2.8, 3.76, 3]
    player_names = ['t1', 't5','t10','t20']

    # Plot multiplayer radar chart
    plot_multiplayer_radar_chart(categories, [player1_data, player2_data, player3_data, player4_data], player_names,
                                 title='Knowledge Mastery Radar Chart Over Time')
